...
# Default-Stop:      0 1 6
# Short-Description: mqttwarn daemon start/stop script
# Description:       Start/Stop script for the mqttwarn daemon
### END INIT INFO

# Author: Ben Jones <ben.jones12@gmail.com>

# Do NOT "set -e"

# PATH should only include /usr/* if it runs after the mountnfs.sh script
PATH=/sbin:/usr/sbin:/bin:/usr/bin
DESC="mqttwarn daemon"
NAME=mqttwarn
